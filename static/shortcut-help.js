...
(function () {
    ...
    var VIEWER_SHORTCUTS = [
        ...
        { key: 'B',      desc: 'Toggle place marker mode' },
        { key: 'K',      desc: 'Pick thread color from canvas' },
    ...
    var EDITOR_SHORTCUTS = [
        ...
        { key: 'L',          desc: 'Line' },
        { key: 'T',          desc: 'Shapes (Rect/Oval/Tri/Diamond/Star)' },
        { key: 'O',          desc: 'Cycle shape mode' },
